package com.itheima.health.health.constant;
...
public class MessageConstant {
   ...
   // 会员cookie的key
    public static final String MEMBER_TELEPHONE = "tel";

    //    RES加密秘钥
    public static final String ORIGIN_KEY = "12jgUQFppppuwkkj";

    public static final String ADD_ADDRESS_FAIL = "新增体检机构地址信息失败";
    public static final String ADD_ADDRESS_SUCCESS = "新增体检机构地址信息成功";
    public static final String EDIT_ADDRESS_FAIL = "编辑体检机构地址信息失败";
    public static final String EDIT_ADDRESS_SUCCESS = "编辑体检机构地址信息成功";
    public static final String DELETE_ADDRESS_SUCCESS = "删除体检机构地址信息成功";
    public static final String DELETE_ADDRESS_FAIL = "删除体检机构地址信息失败";
    public static final String QUERY_ADDRESS_SUCCESS = "查询体检机构地址信息成功";
    public static final String QUERY_ADDRESS_FAIL = "查询体检机构地址信息失败";
